...
//       return;
//     }
//     // Additional flight search logic would go here
//   };
...
//                       setFromSearchTerm(selectedLocation?.name || ""); // Update input with selected location
//                       setFromLocations([]); // Clear dropdown after selection
//                     }}
...
//                       setToSearchTerm(selectedLocation?.name || ""); // Update input with selected location
//                       setToLocations([]); // Clear dropdown after selection
//                     }}
//                     className="bg-white p-2 rounded border border-gray-300 w-full mt-2"
//                   >
...
//         {loading && (
//           <div className="text-center mt-4">Loading locations...</div>
//         )}
